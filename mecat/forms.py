...
class SampleForm(forms.Form):
    ...
    forcode_1 = forms.CharField(max_length=40, required=False, initial="060112 Structural Biology", widget=forms.TextInput(attrs={'class':'sample_forcode'}))
    forcode_2 = forms.CharField(max_length=40, required=False, initial="060199 Biochemistry and cell Biology not elsewhere classified", widget=forms.TextInput(attrs={'class':'sample_forcode'}))
