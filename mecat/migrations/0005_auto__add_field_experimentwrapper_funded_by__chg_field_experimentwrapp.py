...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExperimentWrapper.funded_by'
        db.add_column('mecat_experimentwrapper', 'funded_by', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
        ...
        # Changing field 'Sample.forcode2'
        db.alter_column('mecat_sample', 'forcode2', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Sample.forcode3'
        db.alter_column('mecat_sample', 'forcode3', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Sample.forcode1'
        db.alter_column('mecat_sample', 'forcode1', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Sample.name'
        db.alter_column('mecat_sample', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Deleting field 'ExperimentWrapper.funded_by'
        db.delete_column('mecat_experimentwrapper', 'funded_by')

        # Changing field 'ExperimentWrapper.notes'
        db.alter_column('mecat_experimentwrapper', 'notes', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Sample.forcode2'
        db.alter_column('mecat_sample', 'forcode2', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Sample.forcode3'
        db.alter_column('mecat_sample', 'forcode3', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Sample.forcode1'
        db.alter_column('mecat_sample', 'forcode1', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Sample.name'
        db.alter_column('mecat_sample', 'name', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'mecat.experimentwrapper': {
            ...
            'funded_by': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
