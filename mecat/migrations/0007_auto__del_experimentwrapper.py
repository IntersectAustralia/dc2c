...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('mecat_experimentwrapper', (
            ...
            ('forcode2', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('experiment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tardis_portal.Experiment'])),
            ('forcode1', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
