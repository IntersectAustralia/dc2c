...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('mecat', ['Sample'])

        # Adding model 'DatasetWrapper'
        db.create_table('mecat_datasetwrapper', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sample', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mecat.Sample'])),
            ('dataset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tardis_portal.Dataset'])),
        ))
        db.send_create_signal('mecat', ['DatasetWrapper'])


    def backwards(self, orm):
        
        # Deleting model 'Sample'
        db.delete_table('mecat_sample')

        # Deleting model 'DatasetWrapper'
        db.delete_table('mecat_datasetwrapper')
