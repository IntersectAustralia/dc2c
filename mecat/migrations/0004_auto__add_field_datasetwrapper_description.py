...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DatasetWrapper.description'
        db.add_column('mecat_datasetwrapper', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DatasetWrapper.description'
        db.delete_column('mecat_datasetwrapper', 'description')
