...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DatasetWrapper.name'
        db.add_column('mecat_datasetwrapper', 'name', self.gf('django.db.models.fields.CharField')(default='default', max_length=100), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DatasetWrapper.name'
        db.delete_column('mecat_datasetwrapper', 'name')
