...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DatasetWrapper.immutable'
        db.add_column('mecat_datasetwrapper', 'immutable', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DatasetWrapper.immutable'
        db.delete_column('mecat_datasetwrapper', 'immutable')
    ...
    models = {
        ...
        'mecat.datasetwrapper': {
            ...
            'dataset': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tardis_portal.Dataset']", 'blank': 'True'}),
