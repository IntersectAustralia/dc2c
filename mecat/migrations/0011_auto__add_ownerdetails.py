...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OwnerDetails'
        db.create_table('mecat_ownerdetails', (
        ...
        db.send_create_signal('mecat', ['OwnerDetails'])

    def backwards(self, orm):
        # Deleting model 'OwnerDetails'
        db.delete_table('mecat_ownerdetails')
