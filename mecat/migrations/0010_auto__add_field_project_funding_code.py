...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.funding_code'
        db.add_column('mecat_project', 'funding_code', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.funding_code'
        db.delete_column('mecat_project', 'funding_code')
