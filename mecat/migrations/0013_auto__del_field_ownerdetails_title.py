...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OwnerDetails.title'
        db.delete_column('mecat_ownerdetails', 'title')

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'OwnerDetails.title'
        raise RuntimeError("Cannot reverse this migration. 'OwnerDetails.title' and its values cannot be restored.")
    models = {
        'auth.group': {
